...
$pecah = explode('/',$msg);
	...
	$query = mysql_query("SELECT * from distribusi, penerima, bibit, wilayah where distribusi.nama=penerima.nama and distribusi.nik=penerima.nik and distribusi.kode=bibit.kode and penerima.id_wilayah=wilayah.id and distribusi.tanggal like '%$bulan' order by wilayah.kecamatan ASC");
$no=1;
?>
...
<hr />
<h2 align="center"><strong>Laporan Distribusi Bibit <br />Bulan 
<? 
if($pecah[0]=='01' or '1'){
	echo "Januari";
