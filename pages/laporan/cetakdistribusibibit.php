...
$desa=$_POST['desa'];
	...
	$query = mysql_query("SELECT * from distribusi, penerima, bibit, wilayah where distribusi.nama=penerima.nama and distribusi.nik=penerima.nik and distribusi.kode=bibit.kode and penerima.id_wilayah=wilayah.id and bibit.jenis='$jenis' and wilayah.desa='$desa' order by wilayah.kecamatan ASC");
$no=1;
?>
...
<hr />
<h2 align="center"><strong>Laporan Distribusi Bibit <? echo $jenis; ?><br />Desa <? echo $desa; ?><br />Kecamatan
<? 
$query2 = mysql_query("SELECT * from wilayah where desa='$desa' order by kecamatan ASC");
$namakec = mysql_fetch_array($query2);
echo $namakec['kecamatan']; 
?>
</strong></h2>
