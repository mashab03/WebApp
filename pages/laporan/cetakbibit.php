...
<hr />
<h2 align="center"><strong>Laporan Stok Bibit</strong></h2>

<div class="panel-body">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="table-responsive">
                                        <table  align="center" border="1" cellspacing="0" width="80%" class="table table-bordered table-hover table-striped">
                                            <thead>
                                                <tr>
                                                    <th>No.</th>
                                                    <th>Jenis Bibit</th>
...
?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><div align="center"><?php echo $result['jenis']; ?></div></td>
                                                    <td><div align="center"><?php echo $result['usia']; ?></div></td>
                                                    <td><div align="center"><?php echo $result['jumlah']; ?></div></td>
                                                </tr>
                                              </tbody>
                                              <?php $no++; }?>
                                        </table>
