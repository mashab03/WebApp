<?php 
	...
	$desa=$_POST['desa'];
	$query = mysql_query("SELECT * from penerima, wilayah,bibit where penerima.id_wilayah=wilayah.id and penerima.kode=bibit.kode and wilayah.desa='$desa' order by kecamatan ASC");
	$no=1;
?>
...
<hr />
<h2 align="center"><strong>Laporan Penerima Bibit <br />Desa <? echo $desa; ?><br />Kecamatan 
<? 
