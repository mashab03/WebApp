...
$kec=$_POST['kec'];
	...
	$query = mysql_query("SELECT * from distribusi, penerima, bibit, wilayah where distribusi.nama=penerima.nama and distribusi.nik=penerima.nik and distribusi.kode=bibit.kode and penerima.id_wilayah=wilayah.id and bibit.jenis='$jenis' and wilayah.kecamatan='$kec' order by wilayah.kecamatan ASC");
$no=1;
?>
...
<hr />
<h2 align="center"><strong>Laporan Distribusi Bibit <? echo $jenis; ?><br />Kecamatan <? echo $kec; ?></strong></h2>
