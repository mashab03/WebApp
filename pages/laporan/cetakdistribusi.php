<?php 
	...
	$query = mysql_query("SELECT * from distribusi, penerima, bibit, wilayah where distribusi.nama=penerima.nama and distribusi.nik=penerima.nik and distribusi.kode=bibit.kode and penerima.id_wilayah=wilayah.id order by wilayah.kecamatan and bibit.jenis ASC");
$no=1;
?>
...
<hr />
<h2 align="center"><strong>Laporan Rekap Distribusi Bibit</strong></h2>
