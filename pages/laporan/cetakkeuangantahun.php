...
$tahun=$_POST['tahun'];
	...
	$query = mysql_query("SELECT * from keuangan where keuangan.tanggal_keuangan like '%$tahun' order by tanggal_keuangan ASC");
$no=1;
?>
...
<hr />
<h2 align="center"><strong>Laporan Keuangan <br />Tahun <? echo $tahun; ?></strong></h2>
